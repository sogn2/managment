						...
						<div class="card border-left-primary shadow h-100 py-2">
							<div class="card-body">
								<div class="row no-gutters align-items-center">
									<div class="col mr-2">
										<div class="text-xs font-weight-bold text-primary text-uppercase mb-1"  id="totalList">
											전체방문률</div>
										<div class="row no-gutters align-items-center">
										<div class="col-auto">
											<div class="h5 mb-0 mr-3 font-weight-bold text-gray-800" id="totalVisit">0</div>
										</div>
										<div class="col">
											<div class="progress progress-sm mr-2">
												<div id="totalBar" class="progress-bar" role="progressbar"
					...
					<div class="col-xl-3 col-md-6 mb-4">
						<div class="card border-left-info shadow h-100 py-2">
							<div class="card-body">
								<div class="row no-gutters align-items-center">
									<div class="col mr-2">
										<div class="text-xs font-weight-bold text-info text-uppercase mb-1" id="todayList">
										</div>
										<div class="row no-gutters align-items-center">
											<div class="col-auto">
												<div class="h5 mb-0 mr-3 font-weight-bold text-gray-800" id="todayVisit">0</div>
											</div>
											<div class="col">
												<div class="progress progress-sm mr-2">
													<div id="todayBar" class="progress-bar bg-info" role="progressbar"
...
<script>
	...
	$.ajax({
		url: "/bookingTodayVisitCount",
		type: "GET",
		dataType: "json",
		success: function (data) {
				$('#todayVisit').html(data[2] + "%");
				$('#todayBar').width(data[2] + "%");
				$('#todayList').html("당일 방문률(" + data[0] + "/" + data[1] + ")");

		}
	});
	$.ajax({
		url: "/bookingTotalVisitCount",
		type: "GET",
		dataType: "json",
		success: function (data) {
			$('#totalVisit').html(data[2] + "%");
			$('#totalBar').width(data[2] + "%");
			$('#totalList').html("전체 방문률(" + data[0] + "/" + data[1] + ")");
			console.log(data);
		}
	});
	let today = new Date();
